...
const RentPropertyPage = () => {
  ...
  const pagination = usePagination(filteredProperties, 9);
  ...
  return (
    <Box bg="gray.50">
      ...
      <Box
        position="relative"
        overflow="hidden"
        backgroundImage="url('/images/Rent1.jpg')"
        ...
        >
          <VStack spacing={6} textAlign="center" color={'white'}>
            <HStack>
              ...
              <Heading as="h1" size={['xl',"2xl"]}>Properties To Let</Heading>
            </HStack>
            <Text fontSize="xl">Your new home or office awaits.</Text>
